...
public class Main {
    ...
    public static void main(String[] args) {
        // pada intinya sijava membuat array berupa address
        int[][] array_2D = {
                {1,2,3},
                {4,5},
        };
        ...
        System.out.println(Integer.toHexString(System.identityHashCode(array_char1))); // untuk ngubah menjadi address
